...
Файлы ***numbers***: проверяют, правильно ли работат код.  
Файлы ***timetest***: исполюзуются дл измерения скорости работы кода при увеличении количества чисел в файлах (результаты представлены на графике в файле ***chart***).  
